#
# OMNeT++/OMNEST Makefile for inbaverSim
#
# This file was generated with the command:
#  opp_makemake -f --deep -KINET4_4_PROJ=../../inet4.4 -DINET_IMPORT -I$$\(INET4_4_PROJ\)/src -L$$\(INET4_4_PROJ\)/src -lINET$$\(D\)
#

# Name of target to be created (-o option)
TARGET_DIR = .
TARGET_NAME = inbaverSim$(D)
...
OBJS = \
    $O/ContentDownloadApp.o \
    $O/ContentHostApp.o \
    $O/CRPAlgorithms.o \
    $O/Demiurge.o \
    $O/IoTGatewayApp.o \
    $O/Numen.o \
    $O/RFC8569Forwarder.o \
    $O/SensingApp.o \
    $O/ThingsApp.o \
    $O/WiredTransport.o \
    $O/WirelessTransport.o \
    $O/InternalMessages_m.o \
    $O/RFC8609Messages_m.o \
    $O/TransportMessages_m.o
